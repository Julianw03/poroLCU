...
public interface HovercardV1 extends PluginInterface {
    Function<LCUHttpConnector, LCUApiResponse<SocialInfo>> getFriendInfo(SummonerId summonerId);
    Function<LCUHttpConnector, LCUApiResponse<SocialInfo>> getFriendInfo(Puuid puuid);
}
