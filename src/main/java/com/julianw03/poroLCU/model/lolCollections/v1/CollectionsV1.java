...
public interface CollectionsV1 extends PluginInterface {
    Function<LCUHttpConnector, LCUApiResponse<Backdrop>> getBackdrop(SummonerId summonerId);

    Function<LCUHttpConnector, LCUApiResponse<SpellInventory>> getSpells(SummonerId summonerId);
